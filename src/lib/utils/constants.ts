export const NAV_THEME = {
    light: {
        ...
        primaryForeground: 'hsl(0 0% 98%)', // --primary-foreground
    ...
    dark: {
        ...
        primaryForeground: 'hsl(240 5.9% 10%)', // --primary-foreground
        ...
        chart1: 'hsl(220 70% 50%)', // --chart-1
        chart2: 'hsl(160 60% 45%)', // --chart-2
        chart3: 'hsl(30 80% 55%)', // --chart-3
        chart4: 'hsl(280 65% 60%)', // --chart-4
        chart5: 'hsl(340 75% 55%)', // --chart-5
    },
};
